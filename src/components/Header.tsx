...
import { Menu, X, Wand2, Gamepad2, Info, BookOpen, Users, Mail, Newspaper } from "lucide-react";
...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-left justify-between">
        <a href="/" className="text-3xl font-cinzel font-bold text-wizware-gold flex items-center gap-2">
          <Wand2 className="text-wizware-gold" size={25} />
          WizWare
        </a>
        ...
        <nav className="hidden md:flex items-center space-x-5 ">
          ...
          <a href="/education" className="nav-link font-quicksand flex items-center gap-1">
            <BookOpen className="text-white" size={16} />
            Education
          </a>
          <a href="/blog" className="nav-link font-quicksand flex items-center gap-1">
